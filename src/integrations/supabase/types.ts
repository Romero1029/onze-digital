...
export type Database = {
  ...
  public: {
    Tables: {
      alunos: {
        Row: { autentique_documento_id: string | null; autentique_link_assinatura: string | null; cep: string | null; cidade_estado: string | null; contrato_assinado: boolean | null; contrato_assinado_em: string | null; contrato_enviado: boolean | null; contrato_enviado_em: string | null; cpf: string | null; created_at: string | null; data_fim: string | null; data_inicio: string | null; data_matricula: string | null; data_nascimento: string | null; dia_vencimento: number | null; dia_vencimento_contrato: string | null; email: string | null; endereco: string | null; forms_respondido: boolean | null; forms_respondido_em: string | null; forma_pagamento: string | null; id: string; mensalidades_pagas: number | null; nome: string; observacoes: string | null; origem_lead: string | null; pais: string | null; produto: string | null; status: string | null; total_mensalidades: number | null; turma_id: string | null; updated_at: string | null; valor_mensalidade: number | null; whatsapp: string | null }
        Insert: { autentique_documento_id?: string | null; autentique_link_assinatura?: string | null; cep?: string | null; cidade_estado?: string | null; contrato_assinado?: boolean | null; contrato_assinado_em?: string | null; contrato_enviado?: boolean | null; contrato_enviado_em?: string | null; cpf?: string | null; created_at?: string | null; data_fim?: string | null; data_inicio?: string | null; data_matricula?: string | null; data_nascimento?: string | null; dia_vencimento?: number | null; dia_vencimento_contrato?: string | null; email?: string | null; endereco?: string | null; forms_respondido?: boolean | null; forms_respondido_em?: string | null; forma_pagamento?: string | null; id?: string; mensalidades_pagas?: number | null; nome: string; observacoes?: string | null; origem_lead?: string | null; pais?: string | null; produto?: string | null; status?: string | null; total_mensalidades?: number | null; turma_id?: string | null; updated_at?: string | null; valor_mensalidade?: number | null; whatsapp?: string | null }
        Update: { autentique_documento_id?: string | null; autentique_link_assinatura?: string | null; cep?: string | null; cidade_estado?: string | null; contrato_assinado?: boolean | null; contrato_assinado_em?: string | null; contrato_enviado?: boolean | null; contrato_enviado_em?: string | null; cpf?: string | null; created_at?: string | null; data_fim?: string | null; data_inicio?: string | null; data_matricula?: string | null; data_nascimento?: string | null; dia_vencimento?: number | null; dia_vencimento_contrato?: string | null; email?: string | null; endereco?: string | null; forms_respondido?: boolean | null; forms_respondido_em?: string | null; forma_pagamento?: string | null; id?: string; mensalidades_pagas?: number | null; nome?: string; observacoes?: string | null; origem_lead?: string | null; pais?: string | null; produto?: string | null; status?: string | null; total_mensalidades?: number | null; turma_id?: string | null; updated_at?: string | null; valor_mensalidade?: number | null; whatsapp?: string | null }
